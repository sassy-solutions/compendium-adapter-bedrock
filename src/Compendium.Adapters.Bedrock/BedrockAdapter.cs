// -----------------------------------------------------------------------
// <copyright file="BedrockAdapter.cs" company="Sassy Solutions">
...
namespace Compendium.Adapters.Bedrock;

/// <summary>
/// Bedrock adapter — replace with the real vendor implementation.
...
/// </list>
/// </summary>
public sealed class BedrockAdapter
{
    private readonly BedrockOptions _options;
    private readonly ILogger<BedrockAdapter> _logger;

    /// <summary>
    /// Creates a new <see cref="BedrockAdapter"/>.
    /// </summary>
    /// <param name="options">Adapter configuration.</param>
    /// <param name="logger">Diagnostic logger.</param>
    public BedrockAdapter(IOptions<BedrockOptions> options, ILogger<BedrockAdapter> logger)
    {
